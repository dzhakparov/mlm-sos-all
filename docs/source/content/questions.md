...
* **sp_any** is missing -> sp_egg_white, sp_cowmilk, sp_soy, sp_wheet, sp_fish, sp_peanut 
  ...
  * <span style="color:blue">Meeting 2022-05-08: leave out sp_any and take each single sp... (skinprick) </span>
...
* **solidfood_which_first, medication_oral_which**: only nan
  * <span style="color:blue">Meeting 2022-05-08: not really numeric -> Damir sends list which features he drops from his analysis </span>
...
* why is 'stool-katokatz' not converted to numeric type?
  * <span style="color:blue">Meeting 2022-05-08: no stool: n.a, negativ: 0, positive: 1 </span>
...
* **Swiss children** are not in ```DataTransformed.txt``` -> they should be added in a second file
  ...
  * <span style="color:blue">Meeting 2022-05-08: inclusion by hand (Marco) </span>  
