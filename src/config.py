...
calculate_model_ids = ['0-3-16', '0-3-10',
                       '1-1-1']  # list of ids or a single id as string to calculate ExplainerDashboard

run_dashboard = '1-1-1'  # id of desired model or False
